...
**[View Labs API Documentation →](../api-reference/labs-api.md)**
...
* [API Reference Overview](../api-reference/README.md) - All Molecule APIs
* [Labs API Documentation](../api-reference/labs-api.md) - Detailed file upload guide
* [Data API](../api-reference/data-api.md) - Query IP-NFTs and IPTs
* [How is data stored?](how-is-data-stored.md) - Labs storage architecture
...
_For technical API details, see the [Labs API Documentation](../api-reference/labs-api.md)_
