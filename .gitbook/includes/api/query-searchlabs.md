...
Returns `SearchLabsResult!`.

| Name | Type | Description |
| --- | --- | --- |
| `prompt` | `String!` | Natural-language search text. Truncated to 2000 characters. |
| `filters` | [`SearchLabsFilters`](input-searchlabsfilters.md) | Filters narrowing which labs, tags, categories, access levels and entry kinds are searched. |
