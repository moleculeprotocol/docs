...
| `withIndexerLagRetry(fn)` | Retries a call that failed only because onchain state has not been indexed yet | [Tutorial 1 Step 4](tutorial-1-public-upload.md#step-4-upload-the-file) (after a mint) and [Tutorial 3 Step 4](tutorial-3-agent-access.md#step-4-the-agent-uploads) (after a role grant) |
...
| Create a lab and upload a public file | [Tutorial 1](tutorial-1-public-upload.md) |
| Upload an encrypted file | [Tutorial 2](tutorial-2-encrypted-upload.md) |
| Give your agent access to a lab | [Tutorial 3](tutorial-3-agent-access.md) |
