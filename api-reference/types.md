---
description: Every type in the Molecule GraphQL API, generated from the schema.
---
...
| --- | --- | --- |
| `activities` | [`[LabActivityNode!]!`](/api-reference/types.md#labactivitynode) | Activity entries of the requested page across all labs, newest first. |
...
| Name | Type | Description |
| --- | --- | --- |
| `lab` | [`LabRef!`](/api-reference/types.md#labref) |  |
...
| `headline` | `String!` |  |
| `body` | `String!` |  |
| `attachments` | [`[DataRoomFile!]!`](/api-reference/types.md#dataroomfile) | Files attached to the announcement (at least one; announcements cannot be created without an attachment). |
...
| `logoUrl` | `String!` |  |
| `markets` | [`[Market!]!`](/api-reference/types.md#market) | Markets on this chain; the arguments are accepted but ignored and the full relation is returned. Whether this field resolves data is unverified, so prefer `markets(filterBy: { chainId })`. |
...
| `sortBy` | [`MarketSortBy`](/api-reference/types.md#marketsortby) | Accepted but ignored on this nested field. |
| `filterBy` | [`MarketFilterBy`](/api-reference/types.md#marketfilterby) | Accepted but ignored on this nested field. |
| `sortOrder` | [`SortOrder`](/api-reference/types.md#sortorder) | Accepted but ignored on this nested field. |
...
| `error` | [`ApiError`](/api-reference/types.md#apierror) | Null on success. Non-null means the mutation failed. |
...
| `error` | [`ApiError`](/api-reference/types.md#apierror) | Null on success. Non-null means the mutation failed. |
| `lab` | [`LabRef`](/api-reference/types.md#labref) | Created lab details if successful (minimal fields only). |
...
| `owner` | [`DataRoomOwner!`](/api-reference/types.md#dataroomowner) |  |
| `keywords` | `[String!]` | Empty array rather than null when the data room has no keywords. |
| `files` | [`[DataRoomFile!]`](/api-reference/types.md#dataroomfile) | Files in the data room. Populated by `labWithDataRoomAndFiles`; null when the files could not be listed. |
...
| `lab` | [`LabRef!`](/api-reference/types.md#labref) |  |
| `encryptionMetadata` | [`EncryptionMetadata`](/api-reference/types.md#encryptionmetadata) | Encryption metadata when the file is encrypted (KMS, BLS or a legacy ciphertext); null for plaintext files. |
...
| `accessLevel` | [`DataRoomAccessLevel!`](/api-reference/types.md#dataroomaccesslevel) | Access level of the file. `ADMIN` files are encrypted: read `encryptionMetadata` and unwrap the key with `decryptDataKey`. |
...
| `downloadHeaders` | [`[Header!]`](/api-reference/types.md#header) | Headers that must be sent with the `downloadUrl` request; the download fails without them. |
| `downloadUrlExpiry` | `AWSDateTime` | When `downloadUrl` stops working. Request the file again for a fresh URL. |
| `encryptionMetadata` | [`EncryptionMetadata`](/api-reference/types.md#encryptionmetadata) | Encryption metadata if the file is encrypted (KMS, BLS, or legacy ciphertext). |
| `description` | `String` |  |
...
| Name | Type | Description |
| --- | --- | --- |
| `lab` | [`LabRef!`](/api-reference/types.md#labref) | Lab the file belongs to (search-result hydration tier; see `LabRef`). |
...
| `file` | [`DataRoomFile!`](/api-reference/types.md#dataroomfile) | File's current metadata. |
...
| `status` | [`DidLinkingStatus`](/api-reference/types.md#didlinkingstatus) | Current state of the linking state machine; null before the first attempt. |
...
| `didLinkStatus` | [`DidLinkStatus`](/api-reference/types.md#didlinkstatus) | DID-linking snapshot for the lab. Always present for a well-formed `oclId`, with an unknown lab or one having no linking record reporting null status, hashes and DIDs and zero counts. |
...
| Name | Type | Description |
| --- | --- | --- |
| `data` | [`[FileCategory!]`](/api-reference/types.md#filecategory) | Every valid category with its tags. |
...
| `agreementType` | [`AssignmentAgreementType`](/api-reference/types.md#assignmentagreementtype) | Which agreement was generated, derived from the IPNFT id. Null on failure. |
...
| `error` | [`EvmTokenizationError`](/api-reference/types.md#evmtokenizationerror) | Null on success. Non-null means the mutation failed. |
...
| `agreementType` | [`IptAgreementType`](/api-reference/types.md#iptagreementtype) | Always IPT_MEMBERSHIP on success. Null on failure. |
| `generatedAt` | `AWSDateTime` | When the agreement document was generated. Null on failure. |
| `isSuccess` | `Boolean!` | True when the agreement was generated and stored. |
| `error` | [`EvmTokenizationError`](/api-reference/types.md#evmtokenizationerror) | Null on success. Non-null means the mutation failed. |
...
| `agreementType` | [`OclAgreementType`](/api-reference/types.md#oclagreementtype) | Always OCL_MEMBERSHIP on success. Null on failure. |
...
| `error` | [`EvmTokenizationError`](/api-reference/types.md#evmtokenizationerror) | Null on success. Non-null means the query failed. |
...
| `headers` | [`[Header!]`](/api-reference/types.md#header) | Headers that must be sent with the upload request. Null on failure. |
...
| `owner` | [`User!`](/api-reference/types.md#user) | Current owner. |
| `userId` | `String!` | Id of the current owner (`owner.id`). |
| `originalOwner` | `String!` | Wallet address of the original minter. |
| `ipt` | [`IPT`](/api-reference/types.md#ipt) | **Deprecated.** Use `Lab.tokens`. Removed after 2027-01-01. IP Token minted against this IP-NFT, if it has been tokenized. |
...
| `researchLead` | [`ResearchLead!`](/api-reference/types.md#researchlead) | Project's research lead. |
| `researchLeadId` | `String!` | Email address of the research lead, which is also `ResearchLead.id`. |
| `agreements` | [`[Agreement!]!`](/api-reference/types.md#agreement) | Legal agreement documents attached to the IP-NFT. The arguments are accepted but ignored: the full list is returned. |
...
| `limit` | `Int` | Accepted but ignored on this nested field. |
| `skip` | `Int` | Accepted but ignored on this nested field. |
| `sortBy` | [`AgreementSortBy`](/api-reference/types.md#agreementsortby) | Accepted but ignored on this nested field. |
| `filterBy` | [`AgreementFilterBy`](/api-reference/types.md#agreementfilterby) | Accepted but ignored on this nested field. |
| `sortOrder` | [`SortOrder`](/api-reference/types.md#sortorder) | Accepted but ignored on this nested field. |
...
| `updatedAt` | `String` |  |
| `chainId` | `Int` |  |
| `owner` | [`UserFilterBy`](/api-reference/types.md#userfilterby) | Match on the current owner's fields, e.g. `{ address }`. |
| `userId` | `String` |  |
...
| `researchLead` | [`ResearchLeadFilterBy`](/api-reference/types.md#researchleadfilterby) | Match on the research lead's fields, e.g. `{ email }`. |
| `researchLeadId` | `String` |  |
| `agreements` | [`AgreementFilterBy`](/api-reference/types.md#agreementfilterby) | Not usable: `agreements` is a list relation, which this exact-match filter cannot express; a value here makes the request fail. |
...
| `updatedAt` | `AWSDateTime!` | When Molecule last refreshed the record. |
| `ipnft` | [`IPNFT`](/api-reference/types.md#ipnft) | IP-NFT the token was issued against. Null for tokens with no IP-NFT. |
...
| `markets` | [`[Market!]!`](/api-reference/types.md#market) | Markets trading this token. The arguments are accepted but ignored: the full list is returned. |
| `name` | `String!` |  |
| `symbol` | `String!` |  |
...
| `originalOwner` | [`User!`](/api-reference/types.md#user) |  |
...
| `createdAt` | `String` |  |
| `updatedAt` | `String` |  |
| `ipnft` | [`IPNFTFilterBy`](/api-reference/types.md#ipnftfilterby) | Match on the parent IP-NFT's fields, e.g. `{ topic }`. |
| `ipnftId` | `String` |  |
...
| `originalOwner` | [`UserFilterBy`](/api-reference/types.md#userfilterby) | Match on the original owner's fields, e.g. `{ address }`. |
...
| `account` | [`LabAccount!`](/api-reference/types.md#labaccount) | Owning account of this lab's data room. |
| `dataRoom` | [`DataRoom!`](/api-reference/types.md#dataroom) | Lab's data room: metadata plus, when `files` is selected, its files. |
| `ipnft` | [`IPNFT`](/api-reference/types.md#ipnft) | Legacy IPNFT this lab was migrated from, fully hydrated (owner, researchLead, agreements, ipt) for the single-lab query. Null when the lab has no linked IPNFT. |
| `announcements` | [`[Announcement!]!`](/api-reference/types.md#announcement) | Not served by this API: nothing populates it, so selecting it nulls the whole `Lab` (the field is non-null). Use `labActivity(oclId, filter: ANNOUNCEMENT)` for a lab's announcements instead. |
| `activity` | [`LabActivityNode!`](/api-reference/types.md#labactivitynode) | Not served by this API: nothing populates it, so selecting it nulls the whole `Lab` (the field is non-null). Use the top-level `labActivity(oclId)` query instead. |
...
| `members` | [`[LabMember!]`](/api-reference/types.md#labmember) | Active members of the lab, the same data as the top-level `listLabMembers` query and public with no authentication required. Null only on lookup failure. |
| `tokens` | [`TokenConnection`](/api-reference/types.md#tokenconnection) | Tokens linked to this lab, using `tokens` pagination. Invalid arguments, including `filter.oclId`, fail with `VALIDATION_FAILED`. |
| `legalAgreementStatus` | [`LegalAgreementStatusResult`](/api-reference/types.md#legalagreementstatusresult) | Signed status of a legal agreement for this lab, inlined so a client can fetch it per lab instead of calling `legalAgreementStatus` N times. Public, and null only when the lab cannot be resolved. |
...
| `filters` | [`MoleculeLabActivityFilters`](/api-reference/types.md#moleculelabactivityfilters) | Accepted but ignored; see the field description. |
...
| `filter` | [`TokenFilter`](/api-reference/types.md#tokenfilter) | Typed filters, combined with AND; `oclId` is implied by the parent lab. |
| `orderBy` | [`[TokenOrderInput!]`](/api-reference/types.md#tokenorderinput) | Up to 3 ordering keys. Default `CREATED_AT DESC`. |

**`legalAgreementStatus` arguments**

| Name | Type | Description |
| --- | --- | --- |
| `type` | [`LegalAgreementType!`](/api-reference/types.md#legalagreementtype) | Which legal agreement to report on. |
...
One of [`LabEventFileUpdated`](/api-reference/types.md#labeventfileupdated), [`LabEventFileRemoved`](/api-reference/types.md#labeventfileremoved), [`LabEventFileAdded`](/api-reference/types.md#labeventfileadded), [`LabEventAnnouncement`](/api-reference/types.md#labeventannouncement).
...
| Name | Type | Description |
| --- | --- | --- |
| `nodes` | [`[LabActivityNode!]!`](/api-reference/types.md#labactivitynode) | Activity entries of the requested page, newest first. |
| `pageInfo` | [`PageInfo!`](/api-reference/types.md#pageinfo) | Pagination information for the requested page. |
...
| Name | Type | Description |
| --- | --- | --- |
| `lab` | [`LabRef!`](/api-reference/types.md#labref) | Lab the announcement was posted to. |
| `announcement` | [`Announcement!`](/api-reference/types.md#announcement) |  |
...
| Name | Type | Description |
| --- | --- | --- |
| `lab` | [`LabRef!`](/api-reference/types.md#labref) | Lab whose data room changed. |
| `entry` | [`DataRoomEntry!`](/api-reference/types.md#dataroomentry) |  |
...
| --- | --- | --- |
| `lab` | [`LabRef!`](/api-reference/types.md#labref) | Lab whose data room changed. |
| `entry` | [`DataRoomEntry!`](/api-reference/types.md#dataroomentry) | Removed file, as of its last version. |
...
| Name | Type | Description |
| --- | --- | --- |
| `name` | [`StringFilter`](/api-reference/types.md#stringfilter) | Match on the lab display name. |
| `shortname` | [`StringFilter`](/api-reference/types.md#stringfilter) | Match on the lab shortname. |
...
| `trlValue` | [`TrlValueFilter`](/api-reference/types.md#trlvaluefilter) | Minimum Technology Readiness Level; see `TrlValueFilter`. |
| `member` | [`LabMembershipFilter`](/api-reference/types.md#labmembershipfilter) | Wallet address; selects labs where that wallet holds an active role. |
...
| `role` | [`LabMemberRole!`](/api-reference/types.md#labmemberrole) | Effective role on the lab. |
| `source` | [`LabMemberSource!`](/api-reference/types.md#labmembersource) | Source row that authoritatively defines this membership. |
...
| `role` | [`LabMemberRole`](/api-reference/types.md#labmemberrole) | Restrict to one role; omit to accept any active role. |
...
| Name | Type | Description |
| --- | --- | --- |
| `field` | [`LabOrderField!`](/api-reference/types.md#laborderfield) | Lab attribute to order by. |
| `direction` | [`OrderDirection!`](/api-reference/types.md#orderdirection) | Direction for this key; the server applies it to the `oclId` tiebreaker as well. |
...
| `ipnft` | [`IPNFT`](/api-reference/types.md#ipnft) | Legacy IPNFT this lab was migrated from, hydrated when selected. Null when no IPNFT is linked, and on the activity feeds and `searchLabs`, which expose `ipnftId` for a follow-up lookup. |
...
| `members` | [`[LabMember!]`](/api-reference/types.md#labmember) | Active members of the lab, mirroring the public `listLabMembers` query. Null only on lookup failure. |
| `legalAgreementStatus` | [`LegalAgreementStatusResult`](/api-reference/types.md#legalagreementstatusresult) | Signed status of a legal agreement for this lab, inlined so a client can fetch it per lab instead of calling `legalAgreementStatus` N times. Public, and null only when the lab cannot be resolved. |
...
| Name | Type | Description |
| --- | --- | --- |
| `edges` | [`[LabRefEdge!]!`](/api-reference/types.md#labrefedge) | Page's labs, each with its cursor, in the requested order. |
| `nodes` | [`[LabRef!]!`](/api-reference/types.md#labref) | Convenience list of nodes (same order as edges), for callers that don't need per-item cursors. |
| `pageInfo` | [`ConnectionPageInfo!`](/api-reference/types.md#connectionpageinfo) | Cursors and has-more flags for continuing from this page. |
...
| Name | Type | Description |
| --- | --- | --- |
| `node` | [`LabRef!`](/api-reference/types.md#labref) | Lab at this position. |
...
| Name | Type | Description |
| --- | --- | --- |
| `nodes` | [`[LabRef!]!`](/api-reference/types.md#labref) | Labs on the current page. An empty list means the page is genuinely empty and never stands in for a failure, which fails the request with `UPSTREAM_UNAVAILABLE` or `TIMEOUT` instead. |
...
| `pageInfo` | [`PageInfo!`](/api-reference/types.md#pageinfo) |  |
...
| Name | Type | Description |
| --- | --- | --- |
| `projectFormats` | [`[LabTaxonomyTerm!]!`](/api-reference/types.md#labtaxonomyterm) | Choices for `Lab.projectFormat`; each lab may select one. |
| `therapeuticFields` | [`[LabTaxonomyTerm!]!`](/api-reference/types.md#labtaxonomyterm) | Choices for `Lab.therapeuticFields`; each lab may select several. |
...
| `signedVersions` | [`[SignedLegalAgreementVersion!]`](/api-reference/types.md#signedlegalagreementversion) | Every template version signed for this lab, oldest first, and empty when nothing has been signed. Only authoritative when `error` is null. |
| `error` | [`ApiError`](/api-reference/types.md#apierror) | Field-surface degraded signal (see type docstring). Null on success. |
...
| `agreementType` | [`LegalAgreementType`](/api-reference/types.md#legalagreementtype) | Agreement type the document was populated for; echoes the `type` argument. |
...
| `kind` | [`TokenKind!`](/api-reference/types.md#tokenkind) | Classification to assert: `EXTERNAL` or `BRIDGED` for new tokens. Existing kinds must match unless upgrading `EXTERNAL` to `BRIDGED`, or the request fails. |
...
| `relations` | [`[TokenRelationInput!]`](/api-reference/types.md#tokenrelationinput) | Up to 10 relations to add, preserving existing edges. Duplicates and self-relations fail with `VALIDATION_FAILED`. |
...
| Name | Type | Description |
| --- | --- | --- |
| `token` | [`Token`](/api-reference/types.md#token) | Token after linking, hydrated as requested; null when `error` is non-null. |
| `error` | [`ApiError`](/api-reference/types.md#apierror) | Null on success; otherwise the failure, with no writes applied. |
...
| --- | --- | --- |
| `message` | `String!` | Human-readable status message. |
| `members` | [`[LabMember!]!`](/api-reference/types.md#labmember) | Active members on the lab. Empty array when the lab has no recorded members. |
...
| `chain` | [`Chain!`](/api-reference/types.md#chain) |  |
...
| `token` | [`IPT!`](/api-reference/types.md#ipt) | **Deprecated.** Use `Token.markets`. Removed after 2027-01-01. |
...
| `chain` | [`ChainFilterBy`](/api-reference/types.md#chainfilterby) | Match on the chain's fields, e.g. `{ chainId }`. |
| `chainId` | `Int` |  |
...
| `token` | [`IPTFilterBy`](/api-reference/types.md#iptfilterby) | Match on the traded IP Token's fields, e.g. `{ symbol }`. |
| `iptId` | `String` |  |
| `inverted` | `Boolean` |  |
...
| `events` | [`[RawOnChainEvent!]!`](/api-reference/types.md#rawonchainevent) | Raw events of the transaction in ascending log order. Includes events that did not match the oclId or wallet filter, giving full transaction context. |
...
| `name` | `String!` |  |
| `email` | `String!` |  |
| `ipnfts` | [`[IPNFT!]!`](/api-reference/types.md#ipnft) | IP-NFTs led by this person. The arguments are accepted but ignored: the full list is returned. |
...
| `limit` | `Int` | Accepted but ignored on this nested field. |
| `skip` | `Int` | Accepted but ignored on this nested field. |
| `sortBy` | [`IPNFTSortBy`](/api-reference/types.md#ipnftsortby) | Accepted but ignored on this nested field. |
| `filterBy` | [`IPNFTFilterBy`](/api-reference/types.md#ipnftfilterby) | Accepted but ignored on this nested field. |
| `sortOrder` | [`SortOrder`](/api-reference/types.md#sortorder) | Accepted but ignored on this nested field. |
...
| `attachments` | [`[DataRoomFile!]!`](/api-reference/types.md#dataroomfile) | Files attached to the announcement. |
| `changeBy` | `String!` | Identity of the member who posted the announcement, as `did:ethr:` plus the EIP-55 checksummed wallet address. Older records may hold a bare address or an unverified value. |
| `systemTime` | `AWSDateTime!` | When the announcement was written by the data room backend. |
| `eventTime` | `AWSDateTime!` | When the announcement was posted. |
...
| Name | Type | Description |
| --- | --- | --- |
| `announcement` | [`SearchLabsAnnouncement!`](/api-reference/types.md#searchlabsannouncement) | Matching announcement. |
| `lab` | [`LabRef!`](/api-reference/types.md#labref) | Lab the announcement was posted to (search-result hydration tier; see `LabRef`). |
...
| Name | Type | Description |
| --- | --- | --- |
| `entry` | [`DataRoomFileSearchEntry!`](/api-reference/types.md#dataroomfilesearchentry) | Matching file and the lab it belongs to. |
...
One of [`SearchLabsFileHit`](/api-reference/types.md#searchlabsfilehit), [`SearchLabsAnnouncementHit`](/api-reference/types.md#searchlabsannouncementhit).
...
| Name | Type | Description |
| --- | --- | --- |
| `nodes` | [`[SearchLabsHit!]!`](/api-reference/types.md#searchlabshit) | Hits on the requested page, most relevant first. An empty list means the search matched nothing or this page held only hits this API cannot yet render, and never stands in for a failure. |
...
| `type` | [`LegalAgreementType!`](/api-reference/types.md#legalagreementtype) | Which legal agreement is being signed. |
...
| `kind` | [`TokenKind!`](/api-reference/types.md#tokenkind) |  |
| `name` | `String!` |  |
| `symbol` | `String!` |  |
...
| `lab` | [`LabRef`](/api-reference/types.md#labref) | Linked lab identity and display metadata; null when unlinked. Data-room, activity and assessment fields are null here; use `lab` to retrieve them. |
| `linkSource` | [`TokenLinkSource!`](/api-reference/types.md#tokenlinksource) | How the lab link was established. |
...
| `relations` | [`[TokenRelation!]!`](/api-reference/types.md#tokenrelation) | Relations involving this token, oldest first. Above 50 items fails with `COMPLEXITY_LIMIT_EXCEEDED`, reason `RESULT_CARDINALITY_LIMIT`. |
| `markets` | [`[TokenMarket!]!`](/api-reference/types.md#tokenmarket) | Markets trading this token, highest liquidity first. Above 50 items fails with `COMPLEXITY_LIMIT_EXCEEDED`, reason `RESULT_CARDINALITY_LIMIT`. |
...
| Name | Type | Description |
| --- | --- | --- |
| `edges` | [`[TokenEdge!]!`](/api-reference/types.md#tokenedge) |  |
| `nodes` | [`[Token!]!`](/api-reference/types.md#token) | Tokens in the same order as `edges`. |
| `pageInfo` | [`ConnectionPageInfo!`](/api-reference/types.md#connectionpageinfo) |  |
...
| Name | Type | Description |
| --- | --- | --- |
| `node` | [`Token!`](/api-reference/types.md#token) |  |
...
| Name | Type | Description |
| --- | --- | --- |
| `kind` | [`TokenKindFilter`](/api-reference/types.md#tokenkindfilter) | Token classification filter. |
| `chainId` | [`IntFilter`](/api-reference/types.md#intfilter) | Deployment chain filter. |
| `address` | [`StringFilter`](/api-reference/types.md#stringfilter) | Contract address filter; case-insensitive. |
| `oclId` | [`OclIdFilter`](/api-reference/types.md#oclidfilter) | Linked lab id filter. Fails with `VALIDATION_FAILED` on `Lab.tokens`, where the lab is implied. |
| `symbol` | [`StringFilter`](/api-reference/types.md#stringfilter) | Token symbol filter; case-insensitive. |
...
| Name | Type | Description |
| --- | --- | --- |
| `eq` | [`TokenKind`](/api-reference/types.md#tokenkind) | Exact match on a token kind. |
| `in` | [`[TokenKind!]`](/api-reference/types.md#tokenkind) | Set of matching token kinds, with 1-100 values. |
...
| Name | Type | Description |
| --- | --- | --- |
| `field` | [`TokenOrderField!`](/api-reference/types.md#tokenorderfield) | Field to order by. |
| `direction` | [`OrderDirection!`](/api-reference/types.md#orderdirection) | Direction for this ordering key. |
...
| Name | Type | Description |
| --- | --- | --- |
| `relationType` | [`TokenRelationType!`](/api-reference/types.md#tokenrelationtype) |  |
| `token` | [`TokenRef!`](/api-reference/types.md#tokenref) | Dependent token: bridged copy, locked wrapper, or wrapper. |
| `related` | [`TokenRef!`](/api-reference/types.md#tokenref) | Canonical or underlying token. |
| `source` | [`TokenLinkSource!`](/api-reference/types.md#tokenlinksource) | How the relation was established. |
...
| Name | Type | Description |
| --- | --- | --- |
| `type` | [`TokenRelationType!`](/api-reference/types.md#tokenrelationtype) | Kind of relationship from the linked token to this one. |
| `chainId` | `Int!` | Indexed chain id; others fail with `VALIDATION_FAILED`. |
...
| Name | Type | Description |
| --- | --- | --- |
| `token` | [`Token`](/api-reference/types.md#token) | Token after unlinking, hydrated as requested; null when `error` is non-null. |
| `error` | [`ApiError`](/api-reference/types.md#apierror) | Null on success; otherwise the failure, with no writes applied. |
...
| `ipnfts` | [`[IPNFT!]!`](/api-reference/types.md#ipnft) | IP-NFTs owned by this wallet; the arguments are accepted but ignored. Whether this field resolves data is unverified, so prefer `ipnfts(filterBy: { userId })`. |
| `ipts` | [`[IPT!]!`](/api-reference/types.md#ipt) | **Deprecated.** Use `tokens` with an IPT kind filter. Removed after 2027-01-01. IP Tokens originally issued to this wallet; the arguments are accepted but ignored. Whether this field resolves data is unverified, so prefer `ipts(filterBy: { originalOwnerId })`. |
...
| `limit` | `Int` | Accepted but ignored on this nested field. |
| `skip` | `Int` | Accepted but ignored on this nested field. |
| `sortBy` | [`IPTSortBy`](/api-reference/types.md#iptsortby) | Accepted but ignored on this nested field. |
| `filterBy` | [`IPTFilterBy`](/api-reference/types.md#iptfilterby) | Accepted but ignored on this nested field. |
| `sortOrder` | [`SortOrder`](/api-reference/types.md#sortorder) | Accepted but ignored on this nested field. |
