...
Early-stage research projects, often the ones with the most transformative potential, struggle to raise capital because they don't fit neatly into the risk models of traditional funders. Meanwhile, we continue to see R\&D spending across the industry climbing while outcomes decline (_see Eroom's Law: "drug discovery is becoming slower and more expensive over time, despite improvements in technology"_). The problem is an inability to move science from concept to market at a cost and speed that makes sense, largely because researchers are still forced to work within legacy structures built for a different era.
